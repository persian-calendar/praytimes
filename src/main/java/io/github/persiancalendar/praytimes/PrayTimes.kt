...
class PrayTimes @JvmOverloads constructor(
    ...
    // default times
    private val DEFAULT_IMSAK = 5.0 / 24
    private val DEFAULT_FAJR = 5.0 / 24
    private val DEFAULT_SUNRISE = 6.0 / 24
    private val DEFAULT_DHUHR = 12.0 / 24
    private val DEFAULT_ASR = 13.0 / 24
    private val DEFAULT_SUNSET = 18.0 / 24
    private val DEFAULT_MAGHRIB = 18.0 / 24
    private val DEFAULT_ISHA = 18.0 / 24
