...
class Tests {
    ...
    fun `pray times calculations correctness`() {
        ...
        var prayTimes = prayTimes(
            CalculationMethod.MWL, -4.0, 2018, 9, 5,
            Coordinates(43.0, -80.0, 0.0), AsrMethod.Standard
        )
        ...
        prayTimes = prayTimes(
            CalculationMethod.ISNA, -4.0, 2018, 9, 5,
            Coordinates(43.0, -80.0, 0.0), AsrMethod.Standard
        )
        ...
        prayTimes = prayTimes(
            CalculationMethod.Egypt, -4.0, 2018, 9, 5,
            Coordinates(43.0, -80.0, 0.0), AsrMethod.Hanafi
        )
        ...
        prayTimes = prayTimes(
            CalculationMethod.Makkah, -4.0, 2018, 9, 5,
            Coordinates(43.0, -80.0, -15.0), AsrMethod.Standard
        )
        ...
        prayTimes = prayTimes(
            CalculationMethod.Karachi, -4.0, 2018, 9, 5,
        ...
        prayTimes = prayTimes(
            CalculationMethod.Jafari, -4.0, 2018, 9, 5,
            Coordinates(43.0, -80.0, 0.0), AsrMethod.Standard
        )
        ...
        prayTimes = prayTimes(
            CalculationMethod.Tehran, -4.0, 2018, 9, 5,
            Coordinates(43.0, -80.0, 0.0), AsrMethod.Standard
        )
        ...
        prayTimes = prayTimes(
            CalculationMethod.Tehran, 8.0, 2019, 6, 9,
            Coordinates(3.147778, 101.695278, .0), AsrMethod.Standard
        )
        ...
        prayTimes(
            CalculationMethod.France, 8.0, 2019, 6, 9,
            Coordinates(3.147778, 101.695278, .0), AsrMethod.Standard
        )
        prayTimes(
            CalculationMethod.Russia, 8.0, 2019, 6, 9,
            Coordinates(3.147778, 101.695278, .0), AsrMethod.Standard
        )
        prayTimes(
            CalculationMethod.Singapore, 8.0, 2019, 6, 9,
            Coordinates(3.147778, 101.695278, .0), AsrMethod.Standard
        )
    ...
    private fun prayTimes(
        ...
        method, year, month, dayOfMonth, offset, coordinates, asrMethod, highLatitudesMethod
    )
}
